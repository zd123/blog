...
<div class="highlight"><pre><span class="c"># before using pymongo, you must open a new terminal window and type in </span>
<span class="c"># $ mongod</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># ! pip install pymongo</span>
<span class="kn">from</span> <span class="nn">pymongo</span> <span class="kn">import</span> <span class="n">MongoClient</span>

<span class="c"># CONNECT TO THE TERMINAL WINDOW THING</span>
...
<span class="c"># CREATE AND/OR USE THIS DATABASE</span>
<span class="n">db</span> <span class="o">=</span> <span class="n">client</span><span class="p">[</span><span class="s">&#39;tutorial_database&#39;</span><span class="p">]</span>

<span class="c"># INSEPCT THE DATA BASE</span>
<span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">find_one</span><span class="p">()</span> <span class="o">==</span> <span class="n">db</span><span class="p">[</span><span class="s">&#39;collection_name&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">find_one</span><span class="p">()</span>
<span class="c"># True dat!</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">some_data</span> <span class="o">=</span> <span class="p">{</span><span class="s">&quot;Rapper&quot;</span><span class="p">:</span> <span class="s">&quot;Lil Wayne&quot;</span><span class="p">,</span>
             <span class="s">&quot;Birth-Name&quot;</span><span class="p">:</span> <span class="s">&quot;Dwayne Michael Carter&quot;</span><span class="p">,</span>
             <span class="s">&quot;Best Rapper Alive&quot;</span><span class="p">:</span> <span class="bp">True</span><span class="p">,</span>
             <span class="s">&quot;Occupations&quot;</span><span class="p">:</span> <span class="p">[</span><span class="s">&#39;Rapper&#39;</span><span class="p">,</span> <span class="s">&#39;songwriter&#39;</span><span class="p">,</span> <span class="s">&#39;producer&#39;</span><span class="p">,</span><span class="s">&#39;money getter&#39;</span><span class="p">,</span> <span class="s">&#39;player&#39;</span><span class="p">]</span> 
             <span class="p">}</span> 
<span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="n">some_data</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">some_data</span> <span class="o">=</span> <span class="p">{</span><span class="s">&quot;ID&quot;</span><span class="p">:</span> <span class="s">&quot;Lil Wayne&quot;</span><span class="p">,</span>
             <span class="s">&quot;Label&quot;</span><span class="p">:</span> <span class="s">&quot;Cash Money&quot;</span><span class="p">,</span>
             <span class="s">&quot;Occupation&quot;</span><span class="p">:</span> <span class="s">&quot;Rapper&quot;</span><span class="p">,</span>
             <span class="s">&quot;Albums&quot;</span><span class="p">:</span> <span class="p">[</span><span class="s">&quot;Tha Block Is Hot&quot;</span><span class="p">,</span> <span class="s">&#39;Lights Out&#39;</span><span class="p">,</span> <span class="s">&#39;500 Degreez&#39;</span><span class="p">,</span> <span class="s">&#39;Tha Carter&#39;</span><span class="p">,</span> <span class="s">&#39;Tha Carter II&#39;</span><span class="p">,</span> <span class="s">&#39;Like Father Like Son&#39;</span><span class="p">,</span> <span class="s">&#39;Tha Carter III&#39;</span><span class="p">,</span> <span class="s">&#39;Rebirth&#39;</span><span class="p">,</span> <span class="s">&#39;I Am Not A Human Being&#39;</span><span class="p">,</span> <span class="s">&#39;Tha Carter IV&#39;</span><span class="p">,</span> <span class="s">&#39;I Am Not A Human Being II&#39;</span><span class="p">,</span> <span class="s">&#39;Tha Cater V&#39;</span><span class="p">]</span> <span class="p">}</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">remove</span><span class="p">({</span><span class="s">&quot;Rapper&quot;</span><span class="p">:</span> <span class="s">&quot;Lil Wayne&quot;</span><span class="p">})</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">find_one</span><span class="p">(</span> <span class="p">{</span><span class="s">&quot;ID&quot;</span><span class="p">:</span> <span class="s">&quot;Lil Wayne&quot;</span><span class="p">}</span> <span class="p">)</span>

<span class="c"># OR...</span>
<span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">find</span><span class="p">(</span> <span class="p">{</span><span class="s">&quot;ID&quot;</span><span class="p">:</span> <span class="s">&quot;Lil Wayne&quot;</span><span class="p">}</span> <span class="p">):</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">more_data</span> <span class="o">=</span> <span class="p">{</span><span class="s">&quot;ID&quot;</span><span class="p">:</span> <span class="s">&quot;Kanye West&quot;</span><span class="p">,</span>
             <span class="s">&quot;Occupation&quot;</span><span class="p">:</span> <span class="s">&quot;Rapper&quot;</span><span class="p">,</span>
             <span class="s">&quot;Label&quot;</span><span class="p">:</span> <span class="s">&quot;Roc-A-Fella&quot;</span><span class="p">,</span>
             <span class="s">&quot;Albums&quot;</span><span class="p">:</span> <span class="p">[</span><span class="s">&#39;The College Dropout&#39;</span><span class="p">,</span> <span class="s">&#39;Late Registration&#39;</span><span class="p">,</span> <span class="s">&#39;Graduation&#39;</span><span class="p">,</span>  <span class="s">&#39;808s &amp; Heartbreak&#39;</span><span class="p">,</span> <span class="s">&#39;My Beautiful Dark Twisted Fantasy&#39;</span><span class="p">,</span> <span class="s">&#39;Watch the Throne&#39;</span><span class="p">,</span> <span class="s">&#39;Yeezus&#39;</span><span class="p">]</span> <span class="p">}</span>

<span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="n">more_data</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># db.collection_name.remove({&quot;Rapper&quot;: &quot;Lil Wayne&quot;})</span>
<span class="c"># db.collection_name.remove({&quot;ID&quot;: &quot;Lil Wayne&quot;})</span>
<span class="c"># db.collection_name.remove({&quot;ID&quot;: &quot;Kanye West&quot;})</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">find</span><span class="p">():</span>
    <span class="k">print</span> <span class="n">pp</span><span class="o">.</span><span class="n">pprint</span><span class="p">(</span><span class="n">i</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># COUNT THE NUMBER OF DOCUMENTS IN YOUR TABLE</span>
<span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">count</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># COUNT THE NUMBER OF ITEMS THAT MATCH YOUR QUERY</span>
<span class="n">db</span><span class="o">.</span><span class="n">collection_name</span><span class="o">.</span><span class="n">find</span><span class="p">({</span><span class="s">&quot;Occupation&quot;</span><span class="p">:</span> <span class="s">&quot;Rapper&quot;</span><span class="p">})</span><span class="o">.</span><span class="n">count</span><span class="p">()</span>
</pre></div>
